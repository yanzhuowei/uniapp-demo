<template>
	<view class="list-box">
		...
		<scroll-view class="goods" scroll-y>
			<view class="item" @click="Jump('4001')">
				<!-- 商品图片 -->
				...
				<view class="meta">
					...
					<view class="price"><text>￥</text>1399<text>.00</text></view>
				</view>
			</view>
			<view class="item" @click="Jump('4002')">
				<!-- 商品图片 -->
				<image class="pic" src="/static/uploads/goods_2.jpg"></image>
				<!-- 商品信息 -->
				<view class="meta">
					<view class="name">卡奇莱德汽车车载空气净化器负离子除甲醛PM2.5除烟异味车用氧吧双涡轮出风（红色）</view>
					<view class="price"><text>￥</text>168<text>.00</text></view>
				</view>
			</view>
			<view class="item" @click="Jump('4003')">
				<!-- 商品图片 -->
				<image class="pic" src="/static/uploads/goods_3.jpg"></image>
				<!-- 商品信息 -->
				<view class="meta">
			...
			<view class="item" @click="Jump('4004')">
				<!-- 商品图片 -->
				<image class="pic" src="/static/uploads/goods_4.jpg"></image>
				<!-- 商品信息 -->
				<view class="meta">
					<view class="name">车载冰箱7.5L 冷暖两用汽车冰箱半导体12V迷你电冰箱升级款</view>
					<view class="price"><text>￥</text>488<text>.00</text></view>
				</view>
			</view>
			<view class="item" @click="Jump('4005')">
				<!-- 商品图片 -->
				<image class="pic" src="/static/uploads/goods_5.jpg"></image>
				<!-- 商品信息 -->
				<view class="meta">
					<view class="name">神行者电子狗 神行者L70电子狗测速 测速雷达 流动测速 多种警示路段提醒</view>
					<view class="price"><text>￥</text>600<text>.00</text></view>
				</view>
			</view>
		</scroll-view>
	</view>
